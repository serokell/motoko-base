...
module {
  ...
  public class MapOps<K>(compare : (K, K) -> O.Order) {
    ...
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.entries(rbMap))));
    ///
    /// // [(0, "Zero"), (1, "One"), (2, "Two")]
    /// ```
    ///
    ...
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.entries(rbMap1))));
    ...
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.entries(rbMap2))));
    ...
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.entries(newRbMap))));
    ///
    ...
    /// let rbMap = mapOps.fromIter<Text>(Iter.fromArray([(0, "Zero"), (2, "Two"), (1, "One")]));
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.entries(mapOps.delete(rbMap, 1)))));
    /// Debug.print(debug_show(Iter.toArray(mapOps.entries(mapOps.delete(rbMap, 42)))));
    ///
    /// // [(0, "Zero"), (2, "Two")]
    /// // [(0, "Zero"), (1, "One"), (2, "Two")]
    /// ```
    ...
    /// let mapOps = Map.MapOps<Nat>(Nat.compare);
    ///
    /// let rbMap = mapOps.empty<Text>();
    ///
    /// Debug.print(debug_show(mapOps.size(rbMap)));
    ///
    /// // 0
    /// ```
    ///
    ...
    /// let rbMap = mapOps.fromIter<Text>(Iter.fromArray([(0, "Zero"), (2, "Two"), (1, "One")]));
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.iter(rbMap, #fwd))));
    /// Debug.print(debug_show(Iter.toArray(mapOps.iter(rbMap, #bwd))));
    ///
    /// //  [(0, "Zero"), (1, "One"), (2, "Two")]
    /// //  [(2, "Two"), (1, "One"), (0, "Zero")]
    /// ```
    ...
    public func iter<V>(rbMap : Map<K, V>, direction : Direction) : I.Iter<(K, V)>
      = Internal.iter(rbMap, direction);
    ...
    /// let rbMap = mapOps.fromIter<Text>(Iter.fromArray([(0, "Zero"), (2, "Two"), (1, "One")]));
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.keys(rbMap))));
    ///
    /// // [0, 1, 2]
    /// ```
    /// Cost of iteration over all elements:
    ...
    /// let rbMap = mapOps.fromIter<Text>(Iter.fromArray([(0, "Zero"), (2, "Two"), (1, "One")]));
    ///
    /// Debug.print(debug_show(Iter.toArray(mapOps.vals(rbMap))));
    ///
    /// // ["Zero", "One", "Two"]
    /// ```
    /// Cost of iteration over all elements:
    ...
    /// where `n` denotes the number of key-value entries stored in the map.
    public func map<V1, V2>(rbMap : Map<K, V1>, f : (K, V1) -> V2) : Map<K, V2>
      = Internal.map(rbMap, f);
    ...
    public func size<V>(rbMap : Map<K, V>) : Nat
      = Internal.size(rbMap);
    ...
    ///
    /// Debug.print(debug_show(mapOps.foldLeft(rbMap, (0, ""), folder)));
    ///
    /// // (3, "ZeroOneTwo")
    /// ```
    ///
    ...
    = Internal.foldLeft(rbMap, base, combine);
    ...
    ///   = (key + accum.0, accum.1 # val);
    ///
    /// Debug.print(debug_show(mapOps.foldRight(rbMap, (0, ""), folder)));
    ///
    /// // (3, "TwoOneZero")
    /// ```
    ///
    ...
    = Internal.foldRight(rbMap, base, combine);
  };
  ...
  module Internal {
    ...
    public func mapFilter<K, V1, V2>(rbMap : Map<K, V1>, compare : (K, K) -> O.Order, f : (K, V1) -> ?V2) : Map<K, V2>{
